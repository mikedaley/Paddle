...
SpriteBatData0:     db %00011111, %11111111, %11111000, %00000000
                    db %01111110, %10111101, %01111110, %00000000
                    db %11101100, %00011000, %00110111, %00000000
                    db %11001110, %10111101, %01110011, %00000000
                    db %11111111, %11111111, %11111111, %00000000
                    db %10101010, %10101010, %10101011, %00000000
                    db %11010110, %10111101, %01101011, %00000000
                    db %01111111, %11111111, %11111110, %00000000

                    ds 32 * 71
    
SpriteBatData1:     db %00011111, %11111111, %11111000, %00000000
                    db %01111110, %10111101, %01111110, %00000000
                    db %11110100, %00011000, %00101111, %00000000
                    db %11100110, %10111101, %01100111, %00000000
                    db %11111111, %11111111, %11111111, %00000000
                    db %11010101, %01010101, %01010101, %00000000
                    db %11010110, %10111101, %01101011, %00000000
                    db %01111111, %11111111, %11111110, %00000000

                    ds 32 * 71

SpriteBatData2:     db %00011111, %11111111, %11111000, %00000000
                    db %01111110, %10111101, %01111110, %00000000
                    db %11111000, %00011000, %00011111, %00000000
                    db %11110010, %10111101, %01001111, %00000000
                    db %11111111, %11111111, %11111111, %00000000
                    db %10101010, %10101010, %10101001, %00000000
                    db %11010110, %10111101, %01101011, %00000000
                    db %01111111, %11111111, %11111110, %00000000
