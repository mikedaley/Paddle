...
Score115_0
                    db %00111011, %11111110, %00000000
                    db %01101110, %11000010, %00000000
                    db %01001100, %11011110, %00000000
                    db %01101110, %11000110, %00000000
                    db %00101110, %11111010, %00000000
                    db %01101110, %11111010, %00000000
                    db %01000100, %01000110, %00000000
...
;*******************************************************************************************
; Font data which is loaded in contended memory
;*******************************************************************************************   

                    org 24064   ; Contended memory above the system variables

NumberFont          ; Numbers 0 - 9
                    db %01111100, %10000110, %10001010, %10010010
                    db %10100010, %11000010, %01111100, %00000000
                    db %00001000, %00001000, %00001000, %00001000
                    db %00001000, %00001000, %00001000, %00000000
                    db %01111100, %00000010, %00000010, %01111110
                    db %10000000, %10000000, %11111110, %00000000
                    db %11111100, %00000010, %00000010, %00111100
                    db %00000010, %00000010, %11111100, %00000000
                    db %10000000, %10010000, %10010000, %11111110
                    db %00010000, %00010000, %00010000, %00000000
                    db %01111100, %10000000, %10000000, %01111100
                    db %00000010, %00000010, %01111100, %00000000
                    db %01111100, %10000000, %10000000, %11111100
                    db %10000010, %10000010, %01111100, %00000000
                    db %11111100, %00000010, %00000010, %00000100
                    db %00001000, %00010000, %00100000, %00000000
                    db %01111100, %10000010, %10000010, %01111100
                    db %10000010, %10000010, %01111100, %00000000
                    db %01111100, %10000010, %10000010, %01111110
                    db %00000010, %00000010, %00000010, %00000000


CharFont            ; Letters A-O
                    db %01111100, %10000010, %10000010, %11111110
                    db %10000010, %10000010, %10000010, %00000000
                    db %11111100, %10000010, %10000010, %11111100
                    db %10000010, %10000010, %11111100, %00000000
                    db %01111110, %10000000, %10000000, %10000000
                    db %10000000, %10000000, %01111110, %00000000
                    db %11111100, %10000010, %10000010, %10000010
                    db %10000010, %10000010, %11111100, %00000000
                    db %11111110, %10000000, %10000000, %11111000
                    db %10000000, %10000000, %11111110, %00000000
                    db %11111110, %10000000, %10000000, %11111000
                    db %10000000, %10000000, %10000000, %00000000
                    db %01111100, %10000000, %10000000, %10011110
                    db %10000010, %10000010, %01111100, %00000000
                    db %10000010, %10000010, %10000010, %11111110
                    db %10000010, %10000010, %10000010, %00000000
                    db %11111110, %00010000, %00010000, %00010000
                    db %00010000, %00010000, %11111110, %00000000
                    db %11111110, %00010000, %00010000, %00010000
                    db %00010000, %00010000, %11100000, %00000000
                    db %10000100, %10001000, %10010000, %11100000
                    db %10010000, %10001000, %10000100, %00000000
                    db %10000000, %10000000, %10000000, %10000000
                    db %10000000, %10000000, %11111110, %00000000
                    db %01111100, %10010010, %10010010, %10010010
                    db %10010010, %10000010, %10000010, %00000000
                    db %10000010, %11000010, %10100010, %10010010
                    db %10001010, %10000110, %10000010, %00000000
                    db %01111100, %10000010, %10000010, %10000010
                    db %10000010, %10000010, %01111100, %00000000

                    ; Letters P-Z
                    db %01111100, %10000010, %10000010, %11111100
                    db %10000000, %10000000, %10000000, %00000000
                    db %01111100, %10000010, %10000010, %10010010
                    db %10001010, %10000110, %01111100, %00000000
                    db %11111100, %10000010, %10000010, %11111100
                    db %10001000, %10000100, %10000010, %00000000
                    db %01111110, %10000000, %10000000, %01111100
                    db %00000010, %00000010, %11111100, %00000000
                    db %11111110, %00010000, %00010000, %00010000
                    db %00010000, %00010000, %00010000, %00000000
                    db %10000010, %10000010, %10000010, %10000010
                    db %10000010, %10000010, %11111110, %00000000
                    db %10000010, %10000010, %01000100, %01000100
                    db %00101000, %00010000, %00010000, %00000000
                    db %10000010, %10000010, %10010010, %10010010
                    db %10010010, %10010010, %01101100, %00000000
                    db %10000010, %01000100, %00101000, %00010000
                    db %00101000, %01000100, %10000010, %00000000
                    db %10000010, %10000010, %10000010, %01111100
                    db %00010000, %00010000, %00010000, %00000000
                    db %11111110, %00000100, %00001000, %00010000
                    db %00100000, %01000000, %11111110, %00000000
